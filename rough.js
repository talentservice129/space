...
class Sprite {
  ...
  showSprite() {
    if (true) {
      // You might want to reconsider this condition or provide a meaningful check
      let xPos = this.x;
      let yPos = this.y;
...
function drawScore() {
  ...
  ctx.strokeText("SCORE:" + score, cnvsWidth / 2 - 50, 100);
...
function defaultPlaneImage() {
  let skinUFO = document.getElementById("mainimg");
  skinUFO.src = "./assets/img/space.png";
  console.log("Event Executes");
}

function firstPlaneImage() {
  let skinUFO = document.getElementById("mainimg");
  skinUFO.src = "./assets/img/new folder/1.png";
  console.log("Event Executes");
}

function secondPlaneImage() {
  let skinUFO = document.getElementById("mainimg");
  skinUFO.src = "./assets/img/new folder/2c.png";
  console.log("Event Executes");
}

function thirdPlaneImage() {
  let skinUFO = document.getElementById("mainimg");
  skinUFO.src = "./assets/img/new folder/4.png";
  console.log("Event Executes");
}

function fourthPlaneImage() {
  let skinUFO = document.getElementById("mainimg");
  skinUFO.src = "./assets/img/new folder/5.png";
  console.log("Event Executes");
}

function fifthPlaneImage() {
  let skinUFO = document.getElementById("mainimg");
  skinUFO.src = "./assets/img/new folder/6.png";
  console.log("Event Executes");
}

function selectUFOSkin() {
  let skinUFO = document.getElementById("mainimg");
  console.log(skinUFO.src);
  console.log('Hello')
}